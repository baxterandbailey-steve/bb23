        ...
        <div class="row row-four">
            <figure class="lh-col" data-aos="fade-in">
                ...
                <div class="details">
                    ...
                    <span class="category">Category</span>
                    <p class="description">We helped a vast US audience to believe in the power of new</p>
                </div>
            </figure>
            <figure class="rh-col" data-aos="fade-in">
                ...
                <div class="details">
                    ...
                    <span class="category">Category</span>
                    <p class="description">Using distinct strategy & disarming creativity to show the human face of finance</p>
                </div>
            </figure>
        </div>
        ...
        <div class="row row-five">
            ...
            <figure class="rh-col" data-aos="fade-in">
                ...
                <div class="details">
                    ...
                    <span class="category">Category</span>
                    <p class="description">Ensuring a crucial national lifeline is vital, visible and vibrant</p>
                </div>
            </figure>
        </div>
        ...
        <div class="row row-six">
            <figure class="rh-col" data-aos="fade-in">
                ...
                <div class="details">
                    ...
                    <span class="category">Category</span>
                    <p class="description">Putting a colourful contemporary twist on the Christmas story</p>
                </div>
            </figure>
        </div>
        ...
        <div class="row row-seven">
            <figure class="lh-col" data-aos="fade-in">
                ...
                <div class="details">
                    ...
                    <span class="category">Category</span>
                    <p class="description">Helping to revolutionise, reinvigorate and reinvent a sector, brick by brick</p>
                </div>
            </figure>
            <figure class="rh-col" data-aos="fade-in">
                ...
                <div class="details">
                    ...
                    <span class="category">Category</span>
                    <p class="description">Sharing the secrets of life, the universe and everything</p>
                </div>
            </figure>
        </div>
